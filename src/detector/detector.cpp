...
// int DSSD::ReadTriggerTimes(std::vector<double> &trigger_times) {
// 	trigger_times.clear();
// 	// trigger file name
// 	TString trigger_file_name;
// 	trigger_file_name.Form(
...
// 	TString output_file_name;
// 	output_file_name.Form(
// 		"%s%s%s-fundamental-%04d.root",
// 		kGenerateDataPath, kFundamentalDir, name_.c_str(), run_
// 	);
// 	// pointer to output file
// 	TFile *opf = new TFile(output_file_name, "recreate");
// 	// histogram of look window to look the match window
...
// 	std::multimap<double, DssdMapEvent> match_map;
// 	// show begin
// 	printf("reading detector events   0%%");
// 	fflush(stdout);
// 	// total entries from input
// 	long long entries = ipt->GetEntries();
...
// 	// match and valid events, for statistics
// 	long long match_events = 0;
// 	// oversize events, front or back hit over 8, for statistics
...
// 	// show statistics
// 	std::cout
// 		<< "events match rate " << match_events << " / " << entries
// 		<< "  " << double(match_events) / double(entries) << "\n"
// 		<< "events oversize rate " << oversize_events << " / " << entries
// 		<< "  " << double(oversize_events) / double (entries) << "\n";
